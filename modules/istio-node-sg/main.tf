...
output "istio_nodes_sg_id" {
  value = aws_security_group.istio_nodes.id
}

resource "aws_vpc_security_group_ingress_rule" "istio_nodes_ingress_rule1" {
...
resource "aws_vpc_security_group_ingress_rule" "istio_nodes_ingress_rule2" {
  security_group_id            = aws_security_group.istio_nodes.id
  from_port                    = 443
  to_port                      = 443
  ip_protocol                  = "tcp"
...
resource "aws_vpc_security_group_egress_rule" "istio_nodes_egress_rule1" {
  security_group_id = aws_security_group.istio_nodes.id
  from_port         = 0
  to_port           = 0
  ip_protocol       = "-1"
